...
//import com.example.nakz.managers.KontinuousRecognitionManager
...
import com.sample.nakz.KontinuousRecognitionManager
...
//        Thread.sleep(1500)
    ...
    override fun onKeywordDetected() {
        Log.i("Recognition", "Detected")
        start = true
        tempCenterX = pan_servo
        tempCenterY = tilt_servo
        AllowFaceTracking = false
        sendMessage("Hello")
//        Log.i("Recognition", recognitionManager.checkRecognition())
    }
...
//        Log.i("l and w", "$width $length")
    ...
    private fun speak() {
        Log.i("Recognition", "speak")
//            Log.i("Recognition", recognitionManager.checkRecognition())
        recognitionManager.initRecognizer(start)
        startRecognition()
    }
...
//        }
    ...
    private fun sendMessage(message: String) {
        Log.i("Recognition", "Sent message")
        // Java V2
    ...
    fun callbackV2(response: DetectIntentResponse?) {
        Log.i("Recognition", "message received")
...
//                    Log.e("Timer:", "timer finished")
                        ...
                        object : CountDownTimer(1500, 1000) {
                            override fun onFinish() {
                                this.cancel()
                                mTTS.speak(
                                    "I wish I had legs to breakdance though.",
